...
@Composable
fun ProductoDetailScreen(productId: String, navController: NavController, servicio: ProductoApiServiceC) {
    // Obtén el ViewModel si estás usando uno para el manejo de datos o llama directamente al servicio

    var product by remember { mutableStateOf<ProductoModelGet?>(null) }
